#This is the same code as dtree_ai.py, I have just modified it to use the new dtree that is being generated by the make_new_dtree.py function
#code edited by sd1238
import riskengine
import riskgui
import random
...
def getAction(state, time_left=None):
    ...
    if myDTree is None:
        print 'Loading DTree'
        myDTree = loadDTree('new_dtree.dtree') #modified to use the new dtree obtained from make_new_dtree.py
        print 'Done.'
