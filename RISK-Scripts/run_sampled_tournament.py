...
def print_usage():
    print 'USAGE: python play_risk_ai.py ai_1 name_1 ai_2 name_2 . . . a_n name_n num_players match_length tournament_length (where n is an arbitrary number), num_players is the number of players in a single match, and match_length is the length of each individual match, which should be a multiple of num_players (to fairly alternate who goes first)) tournament_length tells how many matches to hold as part of the tournament'
